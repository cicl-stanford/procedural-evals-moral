...
```
```{r}
emm = fit.brm_exp_1_permissibility_utilitarian_harm_good_cot %>% 
...
# model kant cot
getwd()
df.exp_1_model_kant_cot = read_csv("../../data/results/model_results_long_kant_cot.csv")
...
fit.brm_exp_1_permissibility_kant_harm_good_cot %>% 
  summary()
```