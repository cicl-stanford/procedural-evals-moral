...
for cs, ev, ac, model, method in [(cs, ev, ac, model, method)
    ...
    try:
        ...
        txt_file_permissibility = f"{model}_{method}_cot_util_0.0_50_0_graded_answers_1.txt"
        txt_file_intention = f"{model}_{method}_cot_util_0.0_50_0_graded_answers_2.txt"
...
# save to csv
df.to_csv(os.path.join(DATA_PATH, "model_results_long_util_cot.csv"), index=False)