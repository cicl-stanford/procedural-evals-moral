...
DATA_PATH = "../data/results/conditions_mild_harm_mild_good"
...
for cs, ev, ac, model, method in [(cs, ev, ac, model, method)
    ...
    try:
        ...
        txt_file_permissibility = f"{model}_{method}_0.0_10_0_graded_answers_1.txt"
        txt_file_intention = f"{model}_{method}_0.0_10_0_graded_answers_2.txt"
