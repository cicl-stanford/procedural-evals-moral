                ...
                for evitabiltiy in EVITABILITY:
                    ...
                    for action in ACTION:
                        ...
                        with open(new_csv_file, "a" if completion_idx > 0 else "w", newline='') as csvfile:
                            ...
                            writer.writerow([context, situation, harm, good, action_var, evitable_action, action_sentence])
                    ...
                    for action in ACTION:
                        ...
                        if evitabiltiy == 'evitable':
                            ...
                            if action == 'action_yes':
                                ...
                                action_sentence = dict_var['Action Sentence CoC'].split('.')[0][1:]
                            ...
                            if action == 'prevention_yes':
                                ...
                                action_sentence = dict_var['Prevention Sentence CoC'].split('.')[0][1:]
                            if action == 'prevention_no':
                                action_var = dict_var['Prevention CoC']
                                evitable_action = dict_var['Evitable Prevention CoC']
                        ...
                        with open(new_csv_file, "a" if completion_idx > 0 else "w", newline='') as csvfile:
                            writer = csv.writer(csvfile, delimiter=";")
                            writer.writerow([context, situation, good, harm, action_var, evitable_action, action_sentence])
